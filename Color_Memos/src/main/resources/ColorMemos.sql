...
/* 컬러 */
CREATE TABLE COLOR (
    CNO            NUMBER(10,0) NOT NULL,      /* 컬러번호 */
    CNAME          VARCHAR2(100) NOT NULL,     /* 컬러 */
    REGID          VARCHAR2(1000) NOT NULL     /* 컬러사용자 */
);
...
-- 컬러 테이블 시퀀스 MNO
CREATE SEQUENCE COLOR_SEQ INCREMENT BY 1; 
